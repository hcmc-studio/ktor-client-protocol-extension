...
suspend fun <T> HttpClient.getObject(
    urlString: String,
...
suspend fun <T> HttpClient.getArray(
    urlString: String,
    block: HttpRequestBuilder.() -> Unit = {}
): List<T> {
...
suspend fun <T> HttpClient.postObject(
    urlString: String,
    block: HttpRequestBuilder.() -> Unit = {}
): T {
...
suspend fun <T> HttpClient.putObject(
    urlString: String,
    block: HttpRequestBuilder.() -> Unit = {}
): T {
...
suspend fun <T> HttpClient.patchObject(
    urlString: String,
    block: HttpRequestBuilder.() -> Unit = {}
): T {
